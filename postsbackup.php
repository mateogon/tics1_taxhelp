                ...
                <div class="card-body">
                    ...
                    <div class = "row mx-auto">
                        <div class = "mb-2">
                            ...
                            if ($post['userid'] == (string)$_SESSION['user']['_id']['$oid']){
                        ...
                        if (!$comments->isDead()){
                            ...
                            foreach($comments as $comment){
                                ...
                                echo '<li id= "'.$comment['_id'].'" class="list-group-item">
                                    ...
                                    <div>
                                     ';
                                     if (in_array($userid, (array)$comment['likes-users'])){
                                    ...
                                    if (in_array($userid, (array)$comment['dislikes-users'])){
                                    ...
                                    if ($comment['userid'] == (string)$_SESSION['user']['_id']['$oid']){
                    ...
                    <form action="/new-comment.php?id=<?php echo $post['_id'];?>" method="POST">
